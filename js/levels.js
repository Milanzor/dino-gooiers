...
window.LEVELS = [
  ...
  // Baksteenpatroon: elk dekblok overlapt twee steunpunten, stabiel in physics.
  {
    ...
    enemies: [
      ...
      { type: 'grunt', x: 540, y: 170 },
      { type: 'grunt', x: 620, y: 170 },
    ],
    bonusDino: null,
    par: 5000,
    background: 'jungle',
  ...
  // Ruïnetrap omhoog — vijanden bewaken elke trede
  {
    ...
    enemies: [
      { type: 'grunt', x: 430, y: 290 },
      { type: 'grunt', x: 470, y: 250 },
      { type: 'grunt', x: 510, y: 210 },
      { type: 'grunt', x: 550, y: 170 },
      { type: 'grunt', x: 590, y: 130 },
    ],
    bonusDino: null,
    par: 7500,
    background: 'jungle',
  ...
  // Glazen tempel: vier kolommen (glas buiten, hout binnen) + piramidedak
  {
    ...
    enemies: [
      ...
      { type: 'grunt',      x: 580, y: 130 },
      { type: 'grunt',      x: 520, y: 90  },
      { type: 'grunt',      x: 520, y: 10  },
    ],
    bonusDino: null,
    par: 9000,
    background: 'jungle',
  ...
  // Houten kasteel: twee torens + verbindende muur + TNT in de poortopening
  {
    ...
    enemies: [
      ...
      { type: 'shieldback', x: 540, y: 250 },
      { type: 'grunt',      x: 620, y: 90  },
      { type: 'grunt',      x: 660, y: 90  },
    ],
    bonusDino: null,
    par: 10500,
    background: 'jungle',
  ...
  // Labyrint: drie gescheiden structuren met glas- en TNT-vallen
  {
    ...
    enemies: [
      { type: 'grunt',      x: 420, y: 170 },
      { type: 'grunt',      x: 480, y: 130 },
      { type: 'shieldback', x: 560, y: 210 },
      { type: 'grunt',      x: 640, y: 130 },
      { type: 'grunt',      x: 680, y: 210 },
      { type: 'shieldback', x: 720, y: 170 },
    ],
    bonusDino: null,
    par: 13000,
    background: 'jungle',
  ...
  // Junglekoning: traptempel met TNT-basis en de Tyrannokoning erin
  {
    ...
    enemies: [
      ...
      { type: 'grunt',             x: 420, y: 250 },
      { type: 'grunt',             x: 700, y: 250 },
      { type: 'shieldback',        x: 460, y: 170 },
      { type: 'shieldback',        x: 620, y: 170 },
  ...
  // Solide stenen muur: 4 breed × 4 hoog, houten binnenkern
  {
    ...
    enemies: [
      { type: 'grunt',      x: 520, y: 250 },
      { type: 'shieldback', x: 520, y: 170 },
  ...
  // Dubbele stadspoort: twee stenen bogen naast elkaar
  {
    ...
    enemies: [
      { type: 'grunt',      x: 480, y: 290 },
      { type: 'shieldback', x: 560, y: 210 },
      { type: 'grunt',      x: 600, y: 290 },
  ...
  // Versterkte basis: stalen buitenwanden, houten kern, glazen ramen, TNT op dak
  {
    ...
    enemies: [
      { type: 'grunt',      x: 500, y: 290 },
      { type: 'grunt',      x: 540, y: 290 },
      { type: 'helmet',     x: 520, y: 130 },
      { type: 'shieldback', x: 480, y: 90  },
  ...
  // Stenen brug met centrale TNT-pijler
  {
    ...
    enemies: [
      { type: 'shieldback', x: 440, y: 170 },
      { type: 'grunt',      x: 520, y: 210 },
      { type: 'shieldback', x: 600, y: 170 },
      { type: 'helmet',     x: 520, y: 130 },
    ],
    bonusDino: 'pim',
    par: 13000,
  ...
  // Schildformatie: afwisselende lagen steen–hout, 5 hoog, TNT-punt boven
  {
    ...
    enemies: [
      { type: 'grunt',      x: 440, y: 250 },
      { type: 'shieldback', x: 520, y: 250 },
      { type: 'grunt',      x: 640, y: 250 },
      { type: 'shieldback', x: 500, y: 170 },
      { type: 'grunt',      x: 560, y: 170 },
      { type: 'helmet',     x: 520, y: 90  },
    ],
    bonusDino: null,
    par: 15000,
    background: 'city',
  ...
  // Twee verbonden stadsgebouwen met glazen gang en TNT-kluis
  {
    ...
    enemies: [
      ...
      { type: 'helmet',     x: 460, y: 130 },
      { type: 'grunt',      x: 520, y: 210 },
      { type: 'shieldback', x: 580, y: 90  },
      { type: 'grunt',      x: 620, y: 90  },
  ...
  // Stadsvesting: getrapte stenen burcht, glas + TNT-val halverwege
  {
    ...
    enemies: [
      { type: 'grunt',      x: 400, y: 290 },
      { type: 'grunt',      x: 680, y: 290 },
      { type: 'shieldback', x: 460, y: 250 },
  ...
  // Steenkoning: massief stenen citadel — Gepantserde Ceratops wacht bovenin
  {
    ...
    enemies: [
      ...
      { type: 'grunt',                 x: 380, y: 290 },
      { type: 'grunt',                 x: 700, y: 290 },
      { type: 'shieldback',            x: 440, y: 250 },
      { type: 'shieldback',            x: 640, y: 250 },
      { type: 'helmet',                x: 480, y: 90  },
  ...
  // Explosieve muren: stalen pilaren afgewisseld met TNT
  {
    ...
    enemies: [
      { type: 'grunt',  x: 440, y: 90  },
      { type: 'helmet', x: 520, y: 170 },
      { type: 'helmet', x: 600, y: 170 },
      { type: 'grunt',  x: 680, y: 90  },
      { type: 'bone',   x: 560, y: 130 },
    ],
    bonusDino: null,
    par: 18000,
    background: 'fortress',
  ...
  // Dubbel bolwerk: twee verbonden stalen bastions met glasloopbrug
  {
    ...
    enemies: [
      { type: 'grunt',      x: 400, y: 130 },
      { type: 'helmet',     x: 440, y: 130 },
      { type: 'shieldback', x: 520, y: 250 },
  ...
  // Drie stalen torens van verschillende hoogte
  {
    ...
    enemies: [
      { type: 'helmet', x: 440, y: 130 },
      { type: 'grunt',  x: 560, y: 90  },
      { type: 'bone',   x: 560, y: 10  },
      { type: 'helmet', x: 680, y: 90  },
      { type: 'grunt',  x: 420, y: 170 },
    ],
    bonusDino: null,
    par: 23000,
  ...
  // IJzeren gordijn: brede stalen muur met smalle doorgangen en sluipschutters
  {
    ...
    enemies: [
      { type: 'grunt',  x: 480, y: 290 },
      { type: 'grunt',  x: 600, y: 290 },
      { type: 'helmet', x: 400, y: 130 },
      { type: 'bone',   x: 520, y: 130 },
      { type: 'helmet', x: 640, y: 130 },
      { type: 'grunt',  x: 560, y: 250 },
      { type: 'bone',   x: 680, y: 130 },
    ],
    bonusDino: null,
    par: 26000,
    background: 'fortress',
  ...
  // Wapenopslagplaats: staal + glas + maximale TNT-lading
  {
    ...
    enemies: [
      ...
      { type: 'grunt',      x: 520, y: 210 },
      { type: 'bone',       x: 540, y: 130 },
      { type: 'bone',       x: 540, y: 90  },
      { type: 'helmet',     x: 580, y: 90  },
  ...
  // Laatste Linie: alle materialen tegelijk — brede getrapte mega-constructie
  {
    ...
    enemies: [
      { type: 'grunt',      x: 380, y: 290 },
      { type: 'grunt',      x: 700, y: 290 },
      { type: 'shieldback', x: 480, y: 250 },
      { type: 'shieldback', x: 600, y: 250 },
      { type: 'helmet',     x: 460, y: 210 },
      { type: 'bone',       x: 540, y: 170 },
      { type: 'helmet',     x: 540, y: 130 },
      { type: 'grunt',      x: 540, y: 50  },
  ...
  // Het Bolwerk: pre-eindbaas — twee vleugels + centrale 8-hoge toren
  {
    ...
    enemies: [
      { type: 'grunt',      x: 360, y: 130 },
      { type: 'shieldback', x: 440, y: 210 },
      { type: 'helmet',     x: 500, y: 90  },
      { type: 'bone',       x: 500, y: 10  },
      { type: 'helmet',     x: 560, y: 210 },
      { type: 'shieldback', x: 560, y: 250 },
      { type: 'grunt',      x: 640, y: 130 },
      { type: 'bone',       x: 420, y: 90  },
      { type: 'bone',       x: 580, y: 90  },
      { type: 'grunt',      x: 480, y: 50  },
    ],
    bonusDino: null,
    par: 40000,
    background: 'fortress',
  ...
  // Oertijdtiran: het ultieme fort — alle materialen, Mega Rex binnenin
  {
    ...
    enemies: [
      { type: 'boss_mega_rex', x: 540, y: 210 },
      { type: 'grunt',         x: 340, y: 290 },
      { type: 'grunt',         x: 700, y: 290 },
      { type: 'shieldback',    x: 400, y: 250 },
      { type: 'shieldback',    x: 680, y: 250 },
      { type: 'helmet',        x: 420, y: 210 },
      { type: 'helmet',        x: 660, y: 210 },
      { type: 'bone',          x: 460, y: 130 },
      { type: 'bone',          x: 620, y: 130 },
      { type: 'helmet',        x: 520, y: 90  },
      { type: 'grunt',         x: 520, y: 10  },
    ],
    bonusDino: 'pim',
